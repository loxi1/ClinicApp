                        ...
                        <div class="tab-content ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-group mb-4 mx-md-5 shadow-sm">
                                                ...
                                                <input type="email" id="modalLRInput11" class="form-control form-control-sm"
                                                       placeholder="E-mail" name="txtcorreo" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-group mb-4 mx-md-5 shadow-sm">
                                                ...
                                                <input type="password" id="modalLRInput11" class="form-control form-control-sm"
                                                       placeholder="Contraseña" name="txtpass" required>
                            ...
                            <div class="tab-pane fade" id="panel8" role="tabpanel">
                                ...
                                <div class="modal-body mb-1 mt-5">
                                    ...
                                    <form action="registro_user" method="get" >
                                        <div class="mb-4 mx-md-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-group mb-4 mx-md-5 shadow-sm">     
                                                ...
                                                <input type="email" id="modalLRInput11" class="form-control form-control-sm"
                                                       placeholder="E-mail" name="correo" required>
                                            </div>
                                        </div>


                                        <div class="row">
                                            <div class="input-group mb-5 mx-md-5 shadow-sm">     
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text bg-info badge-dark"><i class="fa fa-user-plus"></i></span>
                                                </div>
                                                <input type="number" id="modalLRInput11" class="form-control form-control-sm"
                                ...
                                <div class="modal-footer">
                                    <div class="options text-right">
                                        ...
                                        <!--<p >¿Ya tienes cuenta? <a href="#panel7" data-toggle="tab" role="tab" class="blue-text">Inicia sesión</a></p>-->
                                    </div>
